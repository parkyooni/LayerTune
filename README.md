    - [# 웹 사이트가 리뉴얼이 발생하면 과거 저장한 정보가 맞지 않습니다.](#%23-%EC%9B%B9-%EC%82%AC%EC%9D%B4%ED%8A%B8%EA%B0%80-%EB%A6%AC%EB%89%B4%EC%96%BC%EC%9D%B4-%EB%B0%9C%EC%83%9D%ED%95%98%EB%A9%B4-%EA%B3%BC%EA%B1%B0-%EC%A0%80%EC%9E%A5%ED%95%9C-%EC%A0%95%EB%B3%B4%EA%B0%80-%EB%A7%9E%EC%A7%80-%EC%95%8A%EC%8A%B5%EB%8B%88%EB%8B%A4)
      - [✔️ 사용자 맞춤형 DOM 요소 관리 및 리뉴얼 대응](#%E2%9C%94%EF%B8%8F-%EC%82%AC%EC%9A%A9%EC%9E%90-%EB%A7%9E%EC%B6%A4%ED%98%95-dom-%EC%9A%94%EC%86%8C-%EA%B4%80%EB%A6%AC-%EB%B0%8F-%EB%A6%AC%EB%89%B4%EC%96%BC-%EB%8C%80%EC%9D%91)
- [✔️ 기능 구현 과정](#%E2%9C%94%EF%B8%8F-%EA%B8%B0%EB%8A%A5-%EA%B5%AC%ED%98%84-%EA%B3%BC%EC%A0%95)
  - [# 익스텐션에서 구글 소셜 로그인 구현](#%23-%EC%9D%B5%EC%8A%A4%ED%85%90%EC%85%98%EC%97%90%EC%84%9C-%EA%B5%AC%EA%B8%80-%EC%86%8C%EC%85%9C-%EB%A1%9C%EA%B7%B8%EC%9D%B8-%EA%B5%AC%ED%98%84)
- [✔️ 프로젝트 회고](#%E2%9C%94%EF%B8%8F-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-%ED%9A%8C%EA%B3%A0)
...
> 웹사이트의 리뉴얼 과정에서 요소들의 추가, 삭제, 개선이 이루어질 경우, 현재 시점의 콘텐츠 구성과 사용자가 이전에 저장했던 콘텐츠 구성 간에 차이가 발생할 수 있습니다. 이로 인해 사용자가 저장했던 콘텐츠 구성이 리뉴얼된 콘텐츠와 상충하게 되며, 사용자는 저장했던 콘텐츠를 사용할 수 없게 되어 다시 새로 변경하고 저장하는 불필요한 작업을 수행해야 할 수 있습니다.
...
이러한 방식으로 사용자의 콘텐츠 구성을 유연하게 유지하고, 리뉴얼에 따른 불편함을 최소화하여 사용자 경험을 개선하고자 합니다.
...
프로젝트를 진행하면서 특정 DOM 요소를 저장하는 기능과 전체 DOM을 스냅샷으로 저장하는 기능을 구현하는 방법에 대해 자료를 조사하고 검증했습니다.

이 과정에서 React의 비교 알고리즘인 재조정(Reconciliation)과 Virtual DOM의 동작 원리를 이해하게 되었습니다. 그 결과, JavaScript에서 React로 마이그레이션했을 때, 익스텐션 개발을 시작하기 전보다 React에 대한 이해가 훨씬 깊어졌다고 느꼈습니다.
